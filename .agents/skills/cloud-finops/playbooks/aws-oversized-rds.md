...
## Fix: Database Rightsizing Levers

1. **RDS Rightsizing in the same family first** (e.g. `db.r5.4xlarge` ->
   `db.r5.2xlarge`). Right-sizing in the same family preserves engine compatibility and
